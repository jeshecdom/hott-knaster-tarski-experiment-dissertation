...
refine (BuildIsLUB _ _).
 ...
 refine (prop_resize_rec _). 
        (* Corollary 1.11.4  *)
 refine (Trunc_rec _). (* Lemma 1.5.25 *)
 refine (sig_rec _ _ _ _).
 intro B. (* Lemma 1.5.25 *)
 refine (prod_ind _ _).
 intros p1 p2. 
 exact (h1 B p1 w p2).
...
pose proof (c_induction f t5) as t6. (* Lemma 2.2.11(iii) *)
...
(****************************************
Chapter 3: Constructing types in HoTT
****************************************)
...
(* Property part of Definition 3.2.1 *)
...
(* Definition 3.2.1 encoded as a record. *)
...
(* Definition 3.2.2 encoded as a record *)
...
(* Property part of Definition 3.2.4
...
(* Definition 3.2.4 encoded as a record. *)
...
(* Property part of Definition 3.2.5(i)  
...
(* Property part of Definition 3.2.5(ii) 
...
(* Property part of Definition 3.2.9(i) 
...
(* Property part of Definition 3.2.9(ii) 
...
(* Lemma 3.2.13 
   ...
   "functor_sigma" is the Sigma_map function of Lemma 1.5.28 *)
...
Proof.
intros P Q p1 w. (* Corollary 1.11.4 *)
refine (Trunc_rec _).
refine (sig_ind _ _ _ _).
...
exists a. (* Lemma 1.8.23 *)
refine (equiv_propresize _ _). 
intros P p1.  
refine (p1 a _).
refine (tr _). (* Corollary 2.4.1 *)
...
assert (Lfp (CanStep A) <= B) as k. (* Corollary 2.4.1 *)
 refine (c_induction (CanStep A) _).
 intro w.
 refine (Trunc_rec _).
 refine (sig_ind _ _ _ _). 
 intros y y_pr. (* Lemma 1.6.23 *)
...
Proof. (* By Lemma 3.2.18 we know "Init A" is a SAlg *)
...
set (h := mor_to_B o proj). (* Lemma 3.2.19 *)
...
Proof. (* It has a LLWinSAlg by Lemma 3.2.7 *)
...
(* That Pow preserves sets is part of Lemma 3.2.24
...
(* Definition 3.2.30
   ...
   We obtain it from Corollary 3.2.22 *)
...
(* Property part of Definition 3.3.1 *)
...
(* Property part of Definition 3.3.4(i)  
...
(* Property part of Definition 3.3.4(ii)  
...
(* Property part of Definition 3.3.8(i)   
...
(* Property part of Definition 3.3.8(ii)   
...
Proof. (* By Lemma 3.3.26 we know "Fin A" is a CoAlg *)
...
set (h := (class_of BehEquiv) o mor_from_B). (* Lemma 3.3.27 *)
...
Proof. (* It has a LLWfinCoAlg by Lemma 3.3.6 *)
...
(* Definition 3.3.37
   ...
   We obtain it from Corollary 3.3.31 *)
...
unfold head_Stream.
unfold tail_Stream. (* Lemma 1.6.1 *)
rewrite eta_prod.
reflexivity.
